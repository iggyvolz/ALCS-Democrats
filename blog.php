...
<div id="blogpost">
    <?php foreach($blogposts as $n=>$blogpost)
    {
        ...
        echo "<h3 class=\"blogtitle\">".($n+1).". $title</h3><h4 class=\"blogdate\">$date</h4><p class=\"blogtext\">$contents</p>";
    }?>
</div>
